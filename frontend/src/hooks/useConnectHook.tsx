...
//     console.log("import.meta.env.VITE_BACKEND_URL", import.meta.env.VITE_LIVEKIT_URL)
...
import { VITE_LIVEKIT_URL, VITE_TOKEN_URL } from "@/constants/URLConstant";
...
const useConnect = () => {
    ...
    console.log("LIVEKIT_URL from env:", VITE_LIVEKIT_URL); // ✅ should log value now
    console.log("LIVEKIT direct:", import.meta.env.VITE_LIVEKIT_URL);


    const createToken = async (
        prompt: string,
        setStatus: React.Dispatch<
            React.SetStateAction<"idle" | "connecting" | "connected" | "ended">
        >
    ) => {
        setStatus("connecting");
        try {
    ...
    return { token, wsUrl: VITE_LIVEKIT_URL, identity, createToken, setToken };
};
